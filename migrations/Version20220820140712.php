 ...
 */
final class Version20220820140712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, tags_id INT NOT NULL, title VARCHAR(45) NOT NULL, slug VARCHAR(45) NOT NULL, article LONGTEXT NOT NULL, published_at DATETIME DEFAULT NULL, modified_at DATETIME DEFAULT NULL, draft TINYINT(1) NOT NULL, censure TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_BFDD31682B36786B (title), UNIQUE INDEX UNIQ_BFDD3168989D9B62 (slug), INDEX IDX_BFDD3168A76ED395 (user_id), INDEX IDX_BFDD31688D7B4FB4 (tags_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
